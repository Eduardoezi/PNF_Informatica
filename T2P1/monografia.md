...
En la era actual, la tecnología no solo transforma procesos productivos y administrativos, sino también moldea las formas de interacción, organización y participación social. A nivel global, el acceso equitativo a recursos tecnológicos se ha convertido en un indicador clave del desarrollo humano. Sin embargo, la brecha digital persiste y se amplifica cuando no existe una cultura de mantenimiento, apropiación y participación en torno al uso de los equipos.

En Venezuela, este fenómeno se agudiza ante las limitaciones estructurales del país: escasez de repuestos, falta de inversión sostenida, restricciones presupuestarias y desactualización tecnológica en instituciones clave. Estas condiciones impactan directamente en la capacidad operativa de organismos públicos y reducen las posibilidades de atención eficiente, oportuna y transparente hacia la ciudadanía.

Los entes gubernamentales, especialmente a nivel municipal, enfrentan un desgaste progresivo de sus recursos tecnológicos. Muchas oficinas operan con equipos obsoletos, sin políticas de mantenimiento preventivo ni protocolos participativos que incluyan a los trabajadores como agentes activos en la solución. Esto genera una dependencia de soluciones improvisadas, fragmenta la operatividad institucional y limita cualquier posibilidad de innovación desde adentro.

Tal es el caso de la Oficina de Recursos Humanos de la Contraloría del Municipio Zamora, en el Estado Aragua. Aunque cumple un rol clave en la gestión del talento humano y en el soporte de los procesos contralores, dicha oficina se encuentra actualmente limitada por el deterioro de su hardware informático. Esta condición afecta la eficiencia del personal, ralentiza los trámites internos y reduce la calidad del servicio prestado.

Frente a esta realidad, se vuelve fundamental abordar el problema no solo desde la dimensión técnica, sino desde una lógica de participación, corresponsabilidad y aprendizaje colectivo. El presente trabajo, por tanto, se propone reflexionar y proyectar una intervención desde el enfoque de Investigación-Acción Participativa (IAP), reconociendo que la tecnología puede y debe ser reapropiada por los propios trabajadores como herramienta para el fortalecimiento institucional y la transformación social.
...
### 2. La claridad teórica como fundamento del quehacer participativo
...
### 9. Dimensión sociopolítica del trabajo colaborativo en espacios gubernamentales
...
### 3. Método
El método empleado es la Investigación-Acción Participativa (IAP), entendida no como una técnica puntual sino como una epistemología en acción. Este método se fundamenta en un proceso cíclico y colaborativo que comprende fases de diagnóstico, planificación, acción, reflexión y sistematización. Su énfasis está puesto en el empoderamiento de los participantes, la democratización del conocimiento y la transformación concreta de la realidad social e institucional.

### 4. Participantes de la investigación
En coherencia con los principios de la IAP, en lugar de hablar de “población y muestra” en un sentido tradicional, se utilizará el concepto de participantes sociales o actores involucrados en el proceso de co-investigación. Estos estarán representados, de forma intencionada y estratégica, por miembros del personal de la Oficina de Recursos Humanos de la Contraloría del Municipio Zamora. Su selección responde a su vínculo directo con el problema abordado y su capacidad para formar parte activa del proceso reflexivo y transformador. Aquí, no se delimita una muestra estadística, sino una comunidad de aprendizaje y acción.
